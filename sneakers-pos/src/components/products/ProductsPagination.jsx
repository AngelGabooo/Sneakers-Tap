  ...
  return (
    ...
    ">
      <div className="flex items-center gap-3 text-sm text-gray-500 dark:text-dark-muted">
        <span>
          Mostrando <span className="font-medium text-brand-black dark:text-dark-text">{start}</span>–<span className="font-medium text-brand-black dark:text-dark-text">{end}</span> de <span className="font-medium text-brand-black dark:text-dark-text">{total}</span> productos
        </span>
