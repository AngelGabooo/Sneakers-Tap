...
export default function SalesHistoryCancelModal({ open, sale, onClose, onConfirm, submitting }) {
      ...
      <div className="w-full max-w-md rounded-xl overflow-hidden bg-white dark:bg-dark-card border border-gray-200 dark:border-dark-border shadow-cardHover">
        ...
        <div className="p-5 space-y-4">
          <p className="text-sm text-gray-600 dark:text-dark-muted">
            La cancelación afectará el registro de la venta y generará las operaciones compensatorias correspondientes en inventario y caja. Esta acción quedará registrada en el historial y auditoría.
          </p>
          ...
          <div>
            <label className="block text-sm font-medium text-brand-black dark:text-dark-text mb-1.5">
              Nota {requiresNotes && <span className="text-brand-red">*</span>}
            </label>
            <textarea
              rows={3}
              value={notes}
