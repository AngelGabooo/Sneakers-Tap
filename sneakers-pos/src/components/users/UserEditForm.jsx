      ...
      <Card>
        <header className="flex items-start gap-3 mb-5">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-dark-muted mt-0.5">
              Solo cámbiala si necesitas restablecer el acceso del empleado.
            </p>
          </div>
        </header>

        <label className="flex items-start gap-3 cursor-pointer mb-4 p-3 rounded-lg border border-gray-200 dark:border-dark-border hover:bg-gray-50 dark:hover:bg-dark-surface transition-colors">
          <input
            type="checkbox"
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-dark-muted mt-0.5">
              Si no marcas esta opción, la contraseña actual se mantiene.
            </p>
          </div>
        </label>
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-dark-muted mt-0.5">
                Puede iniciar sesión y operar según los permisos asignados.
              </p>
            </div>
          </label>
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-dark-muted mt-0.5">
                No podrá iniciar sesión. El historial se conserva intacto.
              </p>
            </div>
          </label>
        </div>
