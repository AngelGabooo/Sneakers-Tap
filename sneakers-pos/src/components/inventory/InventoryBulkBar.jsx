import { SlidersHorizontal, Download, Tag, X } from 'lucide-react'
  ...
  return (
    ...
    ">
      <span className="text-sm font-medium text-brand-blue dark:text-blue-300">
        {count} {count === 1 ? 'variante seleccionada' : 'variantes seleccionadas'}
      </span>

      <div className="flex flex-wrap items-center gap-2 ml-auto">
        <Button size="sm" variant="secondary" icon={SlidersHorizontal} onClick={onAdjust}>
          Ajustar inventario
        </Button>
        <Button size="sm" variant="secondary" icon={Download} onClick={onExport}>
          Exportar
        </Button>
        <Button size="sm" variant="secondary" icon={Tag} onClick={onMarkForRestock}>
